...
namespace UniStore.App
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IUniStoreContext>().To<UniStoreContext>()
                .InRequestScope()
                .WithConstructorArgument("context", kernel.Get<UniStoreEfDbContext>());
            ...
            kernel.Bind<IAuthenticationManager>()
                .ToMethod<IAuthenticationManager>(context =>
            ...
            kernel.Bind<IDepartmentsService>().To<DepartmentsService>().InRequestScope();

            kernel.Bind<ICategoriesService>().To<CategoriesService>().InRequestScope();

            kernel.Bind<ISubCategoriesService>().To<SubCategoriesService>().InRequestScope();
